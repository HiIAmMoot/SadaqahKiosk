...
interface Strings {
    ...
    val skipSignatureCheckConfirmTitle: String get() = "Skip signature check?"
    val skipSignatureCheckConfirmMessage: String get() = "The next install attempt will accept an APK signed with any key, not just this app's — whether or not that attempt succeeds. Only enable this if you are migrating to a different signing key on purpose."
    ...
    // Donation history
    val donationHistory: String get() = "Donation history"
    val donationTrackingEnabled: String get() = "Track donations"
    val donationTrackingDesc: String get() = "Record successful payments locally so you can review totals, averages and trends."
    val tfToday: String get() = "Today"
    val tf7Days: String get() = "7 days"
    val tf30Days: String get() = "30 days"
    val tfYear: String get() = "1 year"
    val tfAllTime: String get() = "All time"
    val tabOverview: String get() = "Overview"
    val tabFrequency: String get() = "Frequency"
    val totalLabel: String get() = "Total"
    val countLabel: String get() = "Donations"
    val averagePerDonation: String get() = "Average per donation"
    val averagePerDay: String get() = "Daily average"
    val averagePerWeek: String get() = "Weekly average"
    val averagePerMonth: String get() = "Monthly average"
    val measuringSince: String get() = "Measuring since"
    val resetAverages: String get() = "Reset averages"
    val resetAveragesConfirm: String get() = "Restart the measurement window from now? Donations stay in the history; only the averages reset."
    val clearHistory: String get() = "Clear history"
    val clearHistoryConfirm: String get() = "Permanently delete every recorded donation? This can't be undone."
    val exportCsv: String get() = "Export CSV"
    val exportCsvSaved: String get() = "Saved to Downloads"
    val exportCsvFailed: String get() = "Export failed"
    val noDonationsYet: String get() = "No donations recorded yet."
    val frequencyAmountHeader: String get() = "Amount"
...
object DutchStrings : Strings {
    ...
    override val skipSignatureCheckConfirmTitle = "Handtekeningcontrole overslaan?"
    override val skipSignatureCheckConfirmMessage = "De volgende installatiepoging accepteert een APK die met eender welke sleutel is ondertekend, niet alleen die van deze app — ongeacht of die poging slaagt. Schakel dit alleen in als u doelbewust naar een andere ondertekeningssleutel migreert."
    ...
    override val donationHistory = "Donatiegeschiedenis"
    override val donationTrackingEnabled = "Donaties bijhouden"
    override val donationTrackingDesc = "Sla geslaagde betalingen lokaal op om totalen, gemiddelden en trends te bekijken."
    override val tfToday = "Vandaag"
    override val tf7Days = "7 dagen"
    override val tf30Days = "30 dagen"
    override val tfYear = "1 jaar"
    override val tfAllTime = "Altijd"
    override val tabOverview = "Overzicht"
    override val tabFrequency = "Frequentie"
    override val totalLabel = "Totaal"
    override val countLabel = "Donaties"
    override val averagePerDonation = "Gemiddelde per donatie"
    override val averagePerDay = "Daggemiddelde"
    override val averagePerWeek = "Weekgemiddelde"
    override val averagePerMonth = "Maandgemiddelde"
    override val measuringSince = "Meten sinds"
    override val resetAverages = "Gemiddelden resetten"
    override val resetAveragesConfirm = "Het meetvenster opnieuw vanaf nu starten? Donaties blijven in de geschiedenis staan; alleen de gemiddelden resetten."
    override val clearHistory = "Geschiedenis wissen"
    override val clearHistoryConfirm = "Alle geregistreerde donaties definitief verwijderen? Dit kan niet ongedaan worden gemaakt."
    override val exportCsv = "CSV exporteren"
    override val exportCsvSaved = "Opgeslagen in Downloads"
    override val exportCsvFailed = "Exporteren mislukt"
    override val noDonationsYet = "Nog geen donaties geregistreerd."
    override val frequencyAmountHeader = "Bedrag"
...
object GermanStrings : Strings {
    ...
    override val skipSignatureCheckConfirmTitle = "Signaturprüfung überspringen?"
    override val skipSignatureCheckConfirmMessage = "Der nächste Installationsversuch akzeptiert eine mit einem beliebigen Schlüssel signierte APK, nicht nur mit dem dieser App — unabhängig davon, ob dieser Versuch erfolgreich ist. Aktivieren Sie dies nur, wenn Sie absichtlich zu einem anderen Signaturschlüssel migrieren."
    ...
    override val donationHistory = "Spendenverlauf"
    override val donationTrackingEnabled = "Spenden erfassen"
    override val donationTrackingDesc = "Erfolgreiche Zahlungen lokal speichern, um Summen, Durchschnitte und Trends einzusehen."
    override val tfToday = "Heute"
    override val tf7Days = "7 Tage"
    override val tf30Days = "30 Tage"
    override val tfYear = "1 Jahr"
    override val tfAllTime = "Gesamt"
    override val tabOverview = "Übersicht"
    override val tabFrequency = "Häufigkeit"
    override val totalLabel = "Summe"
    override val countLabel = "Spenden"
    override val averagePerDonation = "Ø pro Spende"
    override val averagePerDay = "Ø pro Tag"
    override val averagePerWeek = "Ø pro Woche"
    override val averagePerMonth = "Ø pro Monat"
    override val measuringSince = "Erfassung seit"
    override val resetAverages = "Durchschnitte zurücksetzen"
    override val resetAveragesConfirm = "Messzeitraum ab jetzt neu starten? Spenden bleiben im Verlauf erhalten; nur die Durchschnitte werden zurückgesetzt."
    override val clearHistory = "Verlauf löschen"
    override val clearHistoryConfirm = "Alle erfassten Spenden endgültig löschen? Dieser Vorgang lässt sich nicht rückgängig machen."
    override val exportCsv = "CSV exportieren"
    override val exportCsvSaved = "In Downloads gespeichert"
    override val exportCsvFailed = "Export fehlgeschlagen"
    override val noDonationsYet = "Bisher keine Spenden erfasst."
    override val frequencyAmountHeader = "Betrag"
...
object FrenchStrings : Strings {
    ...
    override val skipSignatureCheckConfirmTitle = "Ignorer la vérification de signature ?"
    override val skipSignatureCheckConfirmMessage = "La prochaine tentative d'installation acceptera un APK signé avec n'importe quelle clé, pas seulement celle de cette application — que la tentative réussisse ou non. N'activez ceci que si vous migrez délibérément vers une autre clé de signature."
    ...
    override val donationHistory = "Historique des dons"
    override val donationTrackingEnabled = "Suivre les dons"
    override val donationTrackingDesc = "Enregistrer localement les paiements réussis pour consulter totaux, moyennes et tendances."
    override val tfToday = "Aujourd'hui"
    override val tf7Days = "7 jours"
    override val tf30Days = "30 jours"
    override val tfYear = "1 an"
    override val tfAllTime = "Tout"
    override val tabOverview = "Aperçu"
    override val tabFrequency = "Fréquence"
    override val totalLabel = "Total"
    override val countLabel = "Dons"
    override val averagePerDonation = "Moyenne par don"
    override val averagePerDay = "Moyenne quotidienne"
    override val averagePerWeek = "Moyenne hebdomadaire"
    override val averagePerMonth = "Moyenne mensuelle"
    override val measuringSince = "Mesure depuis"
    override val resetAverages = "Réinitialiser les moyennes"
    override val resetAveragesConfirm = "Redémarrer la période de mesure à partir de maintenant ? Les dons restent dans l'historique ; seules les moyennes sont réinitialisées."
    override val clearHistory = "Effacer l'historique"
    override val clearHistoryConfirm = "Supprimer définitivement chaque don enregistré ? Cette action est irréversible."
    override val exportCsv = "Exporter en CSV"
    override val exportCsvSaved = "Enregistré dans Téléchargements"
    override val exportCsvFailed = "Échec de l'export"
    override val noDonationsYet = "Aucun don enregistré pour le moment."
    override val frequencyAmountHeader = "Montant"
...
object SpanishStrings : Strings {
    ...
    override val skipSignatureCheckConfirmTitle = "¿Omitir la verificación de firma?"
    override val skipSignatureCheckConfirmMessage = "El próximo intento de instalación aceptará un APK firmado con cualquier clave, no solo la de esta aplicación, sin importar si ese intento tiene éxito o no. Actívelo solo si está migrando deliberadamente a una clave de firma diferente."
    ...
    override val donationHistory = "Historial de donaciones"
    override val donationTrackingEnabled = "Registrar donaciones"
    override val donationTrackingDesc = "Guardar localmente los pagos exitosos para revisar totales, promedios y tendencias."
    override val tfToday = "Hoy"
    override val tf7Days = "7 días"
    override val tf30Days = "30 días"
    override val tfYear = "1 año"
    override val tfAllTime = "Todo"
    override val tabOverview = "Resumen"
    override val tabFrequency = "Frecuencia"
    override val totalLabel = "Total"
    override val countLabel = "Donaciones"
    override val averagePerDonation = "Promedio por donación"
    override val averagePerDay = "Promedio diario"
    override val averagePerWeek = "Promedio semanal"
    override val averagePerMonth = "Promedio mensual"
    override val measuringSince = "Midiendo desde"
    override val resetAverages = "Restablecer promedios"
    override val resetAveragesConfirm = "¿Reiniciar el periodo de medición a partir de ahora? Las donaciones permanecen en el historial; solo se restablecen los promedios."
    override val clearHistory = "Borrar historial"
    override val clearHistoryConfirm = "¿Eliminar definitivamente cada donación registrada? Esto no se puede deshacer."
    override val exportCsv = "Exportar CSV"
    override val exportCsvSaved = "Guardado en Descargas"
    override val exportCsvFailed = "Error al exportar"
    override val noDonationsYet = "Aún no hay donaciones registradas."
    override val frequencyAmountHeader = "Importe"
...
object ItalianStrings : Strings {
    ...
    override val skipSignatureCheckConfirmTitle = "Saltare il controllo della firma?"
    override val skipSignatureCheckConfirmMessage = "Il prossimo tentativo di installazione accetterà un APK firmato con qualsiasi chiave, non solo quella di questa app, indipendentemente dal fatto che il tentativo riesca o meno. Attivalo solo se stai migrando intenzionalmente verso una chiave di firma diversa."
    ...
    override val donationHistory = "Cronologia donazioni"
    override val donationTrackingEnabled = "Registra donazioni"
    override val donationTrackingDesc = "Salva localmente i pagamenti riusciti per consultare totali, medie e tendenze."
    override val tfToday = "Oggi"
    override val tf7Days = "7 giorni"
    override val tf30Days = "30 giorni"
    override val tfYear = "1 anno"
    override val tfAllTime = "Sempre"
    override val tabOverview = "Panoramica"
    override val tabFrequency = "Frequenza"
    override val totalLabel = "Totale"
    override val countLabel = "Donazioni"
    override val averagePerDonation = "Media per donazione"
    override val averagePerDay = "Media giornaliera"
    override val averagePerWeek = "Media settimanale"
    override val averagePerMonth = "Media mensile"
    override val measuringSince = "Misurazione da"
    override val resetAverages = "Azzera le medie"
    override val resetAveragesConfirm = "Riavviare il periodo di misurazione da ora? Le donazioni restano nella cronologia; si azzerano solo le medie."
    override val clearHistory = "Cancella cronologia"
    override val clearHistoryConfirm = "Eliminare definitivamente ogni donazione registrata? Operazione irreversibile."
    override val exportCsv = "Esporta CSV"
    override val exportCsvSaved = "Salvato in Download"
    override val exportCsvFailed = "Esportazione non riuscita"
    override val noDonationsYet = "Nessuna donazione registrata."
    override val frequencyAmountHeader = "Importo"
...
object TurkishStrings : Strings {
    ...
    override val skipSignatureCheckConfirmTitle = "İmza kontrolü atlansın mı?"
    override val skipSignatureCheckConfirmMessage = "Bir sonraki yükleme denemesi, yalnızca bu uygulamanınki değil, herhangi bir anahtarla imzalanmış bir APK'yı kabul edecek — bu deneme başarılı olsa da olmasa da. Bunu yalnızca kasıtlı olarak farklı bir imza anahtarına geçiş yapıyorsanız etkinleştirin."
    ...
    override val donationHistory = "Bağış geçmişi"
    override val donationTrackingEnabled = "Bağışları takip et"
    override val donationTrackingDesc = "Başarılı ödemeleri yerel olarak kaydedip toplamları, ortalamaları ve eğilimleri görüntüleyin."
    override val tfToday = "Bugün"
    override val tf7Days = "7 gün"
    override val tf30Days = "30 gün"
    override val tfYear = "1 yıl"
    override val tfAllTime = "Tümü"
    override val tabOverview = "Genel bakış"
    override val tabFrequency = "Sıklık"
    override val totalLabel = "Toplam"
    override val countLabel = "Bağış"
    override val averagePerDonation = "Bağış başına ortalama"
    override val averagePerDay = "Günlük ortalama"
    override val averagePerWeek = "Haftalık ortalama"
    override val averagePerMonth = "Aylık ortalama"
    override val measuringSince = "Ölçüm başlangıcı"
    override val resetAverages = "Ortalamaları sıfırla"
    override val resetAveragesConfirm = "Ölçüm dönemini şu andan itibaren yeniden başlatılsın mı? Bağışlar geçmişte kalır; yalnızca ortalamalar sıfırlanır."
    override val clearHistory = "Geçmişi temizle"
    override val clearHistoryConfirm = "Kaydedilmiş tüm bağışlar kalıcı olarak silinsin mi? Bu işlem geri alınamaz."
    override val exportCsv = "CSV dışa aktar"
    override val exportCsvSaved = "İndirilenler klasörüne kaydedildi"
    override val exportCsvFailed = "Dışa aktarma başarısız"
    override val noDonationsYet = "Henüz bağış kaydı yok."
    override val frequencyAmountHeader = "Tutar"
...
object ArabicStrings : Strings {
    ...
    override val skipSignatureCheckConfirmTitle = "تخطي التحقق من التوقيع؟"
    override val skipSignatureCheckConfirmMessage = "ستقبل محاولة التثبيت التالية حزمة APK موقعة بأي مفتاح، وليس فقط مفتاح هذا التطبيق — سواء نجحت تلك المحاولة أم لا. لا تفعّل هذا إلا إذا كنت تنتقل عمداً إلى مفتاح توقيع مختلف."
    ...
    override val donationHistory = "سجل التبرعات"
    override val donationTrackingEnabled = "تتبع التبرعات"
    override val donationTrackingDesc = "احفظ المدفوعات الناجحة محلياً لمراجعة الإجماليات والمتوسطات والاتجاهات."
    override val tfToday = "اليوم"
    override val tf7Days = "7 أيام"
    override val tf30Days = "30 يوماً"
    override val tfYear = "سنة"
    override val tfAllTime = "كل الفترات"
    override val tabOverview = "نظرة عامة"
    override val tabFrequency = "التكرار"
    override val totalLabel = "الإجمالي"
    override val countLabel = "تبرعات"
    override val averagePerDonation = "المتوسط لكل تبرع"
    override val averagePerDay = "المتوسط اليومي"
    override val averagePerWeek = "المتوسط الأسبوعي"
    override val averagePerMonth = "المتوسط الشهري"
    override val measuringSince = "القياس منذ"
    override val resetAverages = "إعادة تعيين المتوسطات"
    override val resetAveragesConfirm = "هل تريد بدء فترة القياس من الآن؟ تبقى التبرعات في السجل؛ تُعاد المتوسطات فقط."
    override val clearHistory = "مسح السجل"
    override val clearHistoryConfirm = "حذف جميع التبرعات المسجلة نهائياً؟ لا يمكن التراجع عن هذا الإجراء."
    override val exportCsv = "تصدير CSV"
    override val exportCsvSaved = "تم الحفظ في التنزيلات"
    override val exportCsvFailed = "فشل التصدير"
    override val noDonationsYet = "لا توجد تبرعات مسجلة بعد."
    override val frequencyAmountHeader = "المبلغ"
